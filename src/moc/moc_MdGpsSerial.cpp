...
void MdGpsSerial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdGpsSerial::bytesRead)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdGpsSerial::stringRead)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MdGpsSerial::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdGpsSerial::lineRead)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (MdGpsSerial::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdGpsSerial::showStatusMessage)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdGpsSerial::portOpened)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (MdGpsSerial::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdGpsSerial::portClosed)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject MdGpsSerial::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MdGpsSerial.data,
      qt_meta_data_MdGpsSerial,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MdGpsSerial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MdGpsSerial.stringdata0))
        return static_cast<void*>(const_cast< MdGpsSerial*>(this));
