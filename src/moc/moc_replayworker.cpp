...
void ReplayWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ReplayWorker::visualizeDataRecord)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ReplayWorker::clearPlots)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ReplayWorker::showStatusMessage)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject ReplayWorker::staticMetaObject = {
    { &WorkerJob::staticMetaObject, qt_meta_stringdata_ReplayWorker.data,
      qt_meta_data_ReplayWorker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ReplayWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ReplayWorker.stringdata0))
        return static_cast<void*>(const_cast< ReplayWorker*>(this));
