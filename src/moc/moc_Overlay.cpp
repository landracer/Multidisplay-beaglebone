...
#include "../../../multidisplay-app/src/widgets/Overlay.h"
...
const QMetaObject Overlay::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Overlay.data,
      qt_meta_data_Overlay,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
