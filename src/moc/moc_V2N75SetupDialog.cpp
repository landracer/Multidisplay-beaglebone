...
void V2N75SetupDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&V2N75SetupDialog::n75reqDutyMap)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (V2N75SetupDialog::*_t)(quint8 , quint8 , quint8 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&V2N75SetupDialog::n75reqSetpointMap)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&V2N75SetupDialog::n75writeDutyMap)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&V2N75SetupDialog::n75writeSetpointMap)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject V2N75SetupDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_V2N75SetupDialog.data,
      qt_meta_data_V2N75SetupDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *V2N75SetupDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_V2N75SetupDialog.stringdata0))
        return static_cast<void*>(const_cast< V2N75SetupDialog*>(this));
