...
void MdAbstractCom::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdAbstractCom::showStatusMessage)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MdAbstractCom::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdAbstractCom::showStatusBarSampleCount)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdAbstractCom::portOpened)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (MdAbstractCom::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdAbstractCom::portClosed)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdAbstractCom::bytesRead)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject MdAbstractCom::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MdAbstractCom.data,
      qt_meta_data_MdAbstractCom,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MdAbstractCom::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MdAbstractCom.stringdata0))
        return static_cast<void*>(const_cast< MdAbstractCom*>(this));
