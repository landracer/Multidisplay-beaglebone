...
void AndroidN75Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AndroidN75Dialog::n75reqDutyMap)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (AndroidN75Dialog::*_t)(quint8 , quint8 , quint8 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AndroidN75Dialog::n75reqSetpointMap)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AndroidN75Dialog::n75writeDutyMap)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AndroidN75Dialog::n75writeSetpointMap)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject AndroidN75Dialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AndroidN75Dialog.data,
      qt_meta_data_AndroidN75Dialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AndroidN75Dialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AndroidN75Dialog.stringdata0))
        return static_cast<void*>(const_cast< AndroidN75Dialog*>(this));
