...
void MdBinaryProtocol::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::portOpened)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MdBinaryProtocol::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::portClosed)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::n75DutyMapreceived)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::n75SetpointMapreceived)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::ackReceived)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::n75SettingsReceived)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::gearboxSettingsReceived)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (MdBinaryProtocol::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::frameReceived)) {
                *result = 7;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::showStatusMessage)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (MdBinaryProtocol::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MdBinaryProtocol::showStatusBarSampleCount)) {
                *result = 9;
                return;
            }
        }
...
const QMetaObject MdBinaryProtocol::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MdBinaryProtocol.data,
      qt_meta_data_MdBinaryProtocol,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MdBinaryProtocol::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MdBinaryProtocol.stringdata0))
        return static_cast<void*>(const_cast< MdBinaryProtocol*>(this));
